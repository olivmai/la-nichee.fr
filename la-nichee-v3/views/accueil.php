<section>
  ...
  <div class="row accueil-h1">
    <h1 class="main-title">La Nichée, maison traditionnelle en pierre du pays</h1>
  </div><!-- /.row -->

  <div class="row accueil-p">
    <p>Au bout d’une allée privative avec jardin clos de 350 m², rénovée et agrandie, cette maison est située dans le Cotentin (département de la Manche) dans le village de Carteret. C’est un bourg de pêcheurs (de crustacés) très agréable. Le port est à trois cents mètres de la maison, la plage à un kilomètre ; c’est une balade très sympathique et animée en été. De la plage on voit l’île de Jersey située à 35 km de là (une liaison maritime Carteret-Jersey est mise en place pendant la saison).</p>
    <p>Cette maison est idéale pour une location de vacances à la mer, jusqu'à 10/12 couchages. Une partie neuve constitue la pièce de vie avec une grande salle à manger, coin salon, cuisine ouverte et accès à une salle de bain et wc. Egalement au rez-de-chaussée, vous retrouverez un salon avec lit convertible et une grande chambre (capacité jusqu'à 6 couchages). A l'étage se trouvent 3 chambres de deux couchages (lit double) et un salle de bain avec wc.</p>
  </div><!-- /.row -->
